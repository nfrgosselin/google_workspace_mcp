...
# HARDENED: Read-only access only (removed CALENDAR_SCOPE and CALENDAR_EVENTS_SCOPE)
CALENDAR_SCOPES = [CALENDAR_READONLY_SCOPE]

DRIVE_SCOPES = [DRIVE_SCOPE, DRIVE_READONLY_SCOPE, DRIVE_FILE_SCOPE]

# HARDENED: Read-only access only (removed send, compose, modify, labels, settings scopes)
